...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "IdeaSpark Studio transforms your ideas into market-ready products with AI-driven vetting, IP protection, and launch tools." },
